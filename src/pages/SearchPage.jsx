        ...
        <div className="relative flex items-center w-full h-12 rounded-2xl bg-white dark:bg-surface-dark shadow-sm border border-slate-100 dark:border-white/5 transition-all focus-within:ring-2 focus-within:ring-primary/50 focus-within:border-primary">
          ...
          {searchTerm && (
            <button
              ...
              className="flex items-center justify-center px-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors"
            >
      ...
      <div className="flex-1 flex flex-col pt-2 px-4">
            ...
            <div className="flex flex-wrap gap-2">
              {recentSearches.map((term) => (
                <span
                  ...
                  className="inline-flex items-center px-3 py-1 rounded-lg bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 text-sm hover:bg-slate-200 dark:hover:bg-white/10 cursor-pointer transition-colors"
                >
                  {term}
                  <span className="material-symbols-outlined ml-1 text-slate-400 hover:text-slate-600 text-[14px]">
                    close
                  </span>
                </span>
              ))}
        ...
        <div className="flex items-center justify-between pb-3 pt-2">
          <h3 className="text-lg font-bold leading-tight tracking-tight text-slate-900 dark:text-white">
            검색 결과{" "}
            <span className="text-primary ml-1">{filteredItems.length}</span>
          </h3>
        </div>
