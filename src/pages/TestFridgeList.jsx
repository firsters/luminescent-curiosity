...
export default function TestFridgeList() {
    ...
    const mockItems = [
        { id: 'i1', name: 'Apple', status: 'available', fridgeId: '1', expiryDate: new Date(Date.now() + 86400000) },
        { id: 'i2', name: 'Milk', status: 'available', fridgeId: '1', expiryDate: new Date(Date.now() - 86400000) }, // Expired
