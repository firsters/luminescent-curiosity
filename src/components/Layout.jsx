...
function NavLink({ to, icon, label, highlight }) {
  ...
  const baseClass =
    "group flex flex-1 flex-col items-center justify-center gap-1 p-2 transition-colors";
  ...
  return (
    ...
    >
      <span
        className={`material-symbols-outlined text-2xl group-active:scale-90 transition-transform ${
          active ? "fill" : ""
        }`}
      >
        {icon}
