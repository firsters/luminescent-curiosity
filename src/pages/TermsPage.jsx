    ...
    <div className="flex h-full min-h-screen w-full flex-col bg-background-light dark:bg-background-dark">
      ...
      <main className="flex-1 overflow-y-auto px-6 py-8">
        <div className="prose dark:prose-invert prose-sm max-w-none text-text-sub-light dark:text-text-sub-dark">
          ...
          <h3>제7조 (계약 해지 및 데이터 삭제)</h3>
          <p>
            1. 회원은 언제든지 서비스 내 설정 메뉴를 통하여 이용계약 해지 신청(회원 탈퇴)을 할 수 있으며, 회사는 관련 법령 등이 정하는 바에 따라 이를 즉시 처리하여야 합니다.<br />
            2. 회원이 계약을 해지할 경우, 관련 법령 및 개인정보처리방침에 따라 회사가 회원정보를 보유하는 경우를 제외하고는 해지 즉시 회원의 모든 데이터는 소멸됩니다.<br />
            3. 단, 가족 그룹 기능을 통해 다른 회원과 공유된 데이터(냉장고, 아이템 등)는 가족 그룹의 마지막 구성원이 탈퇴할 때까지 보관되며, 마지막 구성원이 탈퇴하는 시점에 일괄 삭제됩니다.
          </p>
